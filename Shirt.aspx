<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Shirt.aspx.cs" Inherits="Shirt" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <table style="width:100%; height:70px">
      <tr>
          <td style="background-color:rosybrown; color:white; text-align:center; font-family:'Times New Roman'; font-size:30px">‧˚₊‧♡ SHIRTS ♡‧₊˚</td>
      </tr>
  </table>
    <asp:DataList ID="DataList1" runat="server" BackColor="#CCCCCC" BorderColor="White" BorderWidth="3px" CellPadding="4" DataKeyField="MASP" DataSourceID="SqlDataSource1" BorderStyle="Solid" Font-Bold="True" Font-Italic="False" Font-Names="Times New Roman" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" GridLines="Both" RepeatColumns="3" HorizontalAlign="Center" CellSpacing="2" ForeColor="Black" Width="1000px">
...
<br />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:QL_WEBLUNAConnectionString %>" SelectCommand="SELECT * FROM [SANPHAM] WHERE ([MALOAI] = @MALOAI)">
        <SelectParameters>
            <asp:ControlParameter ControlID="DataList1" DefaultValue="1" Name="MALOAI" PropertyName="SelectedValue" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
</asp:Content>
