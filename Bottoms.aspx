<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Bottoms.aspx.cs" Inherits="Bottoms" %>
...
<br />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:QL_WEBLUNAConnectionString %>" SelectCommand="SELECT * FROM [SANPHAM] WHERE ([MALOAI] = @MALOAI)">
        <SelectParameters>
            <asp:ControlParameter ControlID="DataList1" DefaultValue="5" Name="MALOAI" PropertyName="SelectedValue" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
</asp:Content>
