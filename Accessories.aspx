...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <table style="width:100%; height:70px">
      <tr>
          <td style="background-color:rosybrown; color:white; text-align:center; font-family:'Times New Roman'; font-size:30px">‧˚₊‧♡ ACCESSORIES ♡‧₊˚⋅</td>
      </tr>
  </table>
...
<br />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:QL_WEBLUNAConnectionString %>" SelectCommand="SELECT * FROM [SANPHAM] WHERE ([MALOAI] = @MALOAI)">
        <SelectParameters>
            <asp:ControlParameter ControlID="DataList1" DefaultValue="7" Name="MALOAI" PropertyName="SelectedValue" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
</asp:Content>
