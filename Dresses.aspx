<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Dresses.aspx.cs" Inherits="Dresses" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <table style="width:100%; height:70px">
      <tr>
          <td style="background-color:rosybrown; color:white; text-align:center; font-family:'Times New Roman'; font-size:30px">‧˚₊‧♡ DRESSES ♡‧₊˚</td>
      </tr>
  </table>
    <asp:DataList ID="DataList1" runat="server" BackColor="#CCCCCC" BorderColor="White" CellPadding="4" DataKeyField="MASP" DataSourceID="SqlDataSource1" ForeColor="Black" GridLines="Both" HorizontalAlign="Center" RepeatColumns="3" CellSpacing="2" Font-Bold="True" Font-Italic="False" Font-Names="Times New Roman" Font-Overline="False" Font-Size="Medium" Font-Strikeout="False" Font-Underline="False" Width="1000px">
...
<br />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:QL_WEBLUNAConnectionString %>" SelectCommand="SELECT * FROM [SANPHAM] WHERE ([MALOAI] = @MALOAI)">
        <SelectParameters>
            <asp:ControlParameter ControlID="DataList1" DefaultValue="4" Name="MALOAI" PropertyName="SelectedValue" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
</asp:Content>
